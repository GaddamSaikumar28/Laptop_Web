/* src/api/shreddingApi.js */

// import { supabase } from './supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';
import { supabase } from '../supabaseClient';
const BUCKET_NAME = 'shredding_page_media';
const TABLE_NAME = 'shredding_page_content';

/**
 * Fetches all content for the Shredding page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching shredding page content:', error);
    throw error;
  }

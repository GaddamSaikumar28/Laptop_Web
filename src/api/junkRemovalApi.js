/* src/api/junkRemovalApi.js */

import { supabase } from '../supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';

const BUCKET_NAME = 'junk_removal_media';
const TABLE_NAME = 'junk_removal_content';

/**
 * Fetches all content for the Junk Removal page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching junk removal content:', error);
    throw error;
  }

/* src/api/decommissionApi.js */

import { supabase } from '../supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';

const BUCKET_NAME = 'decommission_page_media';
const TABLE_NAME = 'decommission_page_content';

/**
 * Fetches all content for the Decommission page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching decommission page content:', error);
    throw error;
  }

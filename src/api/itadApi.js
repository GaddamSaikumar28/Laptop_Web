...
const BUCKET_NAME = 'itad_page_media';
const TABLE_NAME = 'itad_page_content';

/**
 * Fetches all content for the ITAD page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching ITAD page content:', error);
    throw error;
  }

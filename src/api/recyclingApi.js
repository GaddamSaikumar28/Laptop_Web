/* src/api/recyclingApi.js */

// import { supabase } from './supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';
import { supabase } from '../supabaseClient';
const BUCKET_NAME = 'recycling_page_media';
const TABLE_NAME = 'recycling_page_content';

/**
 * Fetches all content for the Recycling page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching recycling page content:', error);
    throw error;
  }

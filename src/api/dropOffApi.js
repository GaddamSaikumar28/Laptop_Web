/* src/api/dropOffApi.js */

import { supabase } from '../supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';

const BUCKET_NAME = 'drop_off_page_media';
const TABLE_NAME = 'drop_off_page_content';

/**
 * Fetches all content for the Drop Off page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching drop-off page content:', error);
    throw error;
  }

...
const BUCKET_NAME = 'consultation_page_media';
const TABLE_NAME = 'consultation_page_content';

/**
 * Fetches all content for the Consultation page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching consultation page content:', error);
    throw error;
  }

...
const BUCKET_NAME = 'itam_page_media';
const TABLE_NAME = 'itam_page_content';

/**
 * Fetches all content for the ITAM page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching ITAM page content:', error);
    throw error;
  }

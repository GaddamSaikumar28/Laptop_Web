/* src/api/acceptedItemsApi.js */

import { supabase } from '../supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';

const BUCKET_NAME = 'accepted_items_media';
const TABLE_NAME = 'accepted_items_content';

/**
 * Fetches all content for the Accepted Items page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching accepted items content:', error);
    throw error;
  }

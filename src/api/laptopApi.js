/* src/api/laptopApi.js */

import { supabase } from '../supabaseClient'; // Assuming your client is here
import { v4 as uuidv4 } from 'uuid';

const BUCKET_NAME = 'laptop_page_media';
const TABLE_NAME = 'laptop_page_content';

/**
 * Fetches all content for the Laptops page.
...
export const getContent = async () => {
  ...
  if (error) {
    console.error('Error fetching laptop page content:', error);
    throw error;
  }
